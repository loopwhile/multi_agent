...
- **기준**: `ai_prompts/workflows/verification_gate.md`
...
- **DG1, DG2**: 패스트트랙 조건 충족 시 DG1+DG2를 another_me 약식 승인으로 대체 가능
  - 패스트트랙 조건: `ai_prompts/workflows/work_order_lifecycle.md` 참조
...
- Scope Review: `ai_prompts/reviews/scope_review.md`
- Architecture Review: `ai_prompts/reviews/architecture_review.md`
- Release Review: `ai_prompts/reviews/release_review.md`
