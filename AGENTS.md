...
프로젝트 루트에 위치하며, Codex CLI가 자동으로 로드한다.

## Global Rules
- 모든 에이전트는 `codex_cli_multi_agent/docs/03_rules.md`를 우선 준수한다.
...
- Role File: `codex_cli_multi_agent/roles/another_me.md`
- Task Context: `codex_cli_multi_agent/tasks/project_analysis.md`
- Recommended Profile: `another_me`

### product_scope_agent (The Product Owner)
- Role File: `codex_cli_multi_agent/roles/product_scope_agent.md`
- Task Context: `codex_cli_multi_agent/tasks/scope_lock.md`
- Recommended Profile: `product_scope_agent`

### system_architect_agent (The Tech Lead)
- Role File: `codex_cli_multi_agent/roles/system_architect_agent.md`
- Task Context: `codex_cli_multi_agent/tasks/architecture_design.md`
- Recommended Profile: `system_architect_agent`

### builder_agent (The Senior Developer)
- Role File: `codex_cli_multi_agent/roles/builder_agent.md`
- Task Context: `codex_cli_multi_agent/tasks/implementation_plan.md`
- Recommended Profile: `builder_agent`

### quality_verification_agent (The QA Engineer)
- Role File: `codex_cli_multi_agent/roles/quality_verification_agent.md`
- Validation Context: `codex_cli_multi_agent/validation/quality_checklist.md`
- Recommended Profile: `quality_verification_agent`

### operations_workflow_agent (The DevOps Engineer)
- Role File: `codex_cli_multi_agent/roles/operations_workflow_agent.md`
- Workflow Context: `codex_cli_multi_agent/workflows/work_order_lifecycle.md`
- Recommended Profile: `operations_workflow_agent`

### growth_feedback_agent (The Growth Analyst)
- Role File: `codex_cli_multi_agent/roles/growth_feedback_agent.md`
- Task Context: `codex_cli_multi_agent/tasks/feedback_analysis.md`
- Recommended Profile: `growth_feedback_agent`

## Skill Routing
- Skills are in `codex_cli_multi_agent/.agents/skills/`.
...
6. 역할 충돌 시 `codex_cli_multi_agent/workflows/escalation_protocol.md`를 따른다.
...
5. 커밋 전 확인:
   ...
   - `codex_cli_multi_agent/tasks/<WO>.md`와 `codex_cli_multi_agent/docs/session_handoff.md` 동기화 완료
...
1. Load `codex_cli_multi_agent/docs/03_rules.md`.
2. Load one role file from `codex_cli_multi_agent/roles/`.
3. Load one project packet from `codex_cli_multi_agent/docs/project_packets/` (create from template if absent).
